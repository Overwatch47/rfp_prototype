import { Brain, CheckCircle, Clock, Send, Activity } from 'lucide-react';
    ...
    <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-purple-500/30 rounded-2xl p-6 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700 hover:border-slate-600 text-gray-300 text-sm font-semibold rounded-lg transition-all duration-300">
            Export PDF
          </button>
          <button className="px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700 hover:border-slate-600 text-gray-300 text-sm font-semibold rounded-lg transition-all duration-300">
            Save Draft
